...
double geo_cdf_pdf(double args[]) { return gsl_ran_geometric_pdf(args[0], args[1]); }
double geo_cdf_P(double args[]) { return gsl_cdf_geometric_P(args[0], args[1]); }
double geo_cdf_Q(double args[]) { return gsl_cdf_geometric_Q(args[0], args[1]); }
...
double weibull_P(double args[]) { return gsl_cdf_weibull_P(args[0], args[1], args[2]); }
double weibull_Q(double args[]) { return gsl_cdf_weibull_Q(args[0], args[1], args[2]); }
double weibull_Pinv(double args[]) { return gsl_cdf_weibull_Pinv(args[0], args[1], args[2]); }
double weibull_Qinv(double args[]) { return gsl_cdf_weibull_Qinv(args[0], args[1], args[2]); }
